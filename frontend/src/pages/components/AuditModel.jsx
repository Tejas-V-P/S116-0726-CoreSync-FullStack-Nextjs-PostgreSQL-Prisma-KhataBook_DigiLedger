                            ...
                            {logs.map((log) => {
                                ...
                                return (
                                    <div key={log.id} className="relative pl-6">
                                        {/* Dot Icon */}
                                        <div
                                            className={`absolute -left-[9px] top-1.5 w-4 h-4 rounded-full border-2 border-white dark:border-slate-900 ${isCreate
                                                    ? 'bg-emerald-500'
                                                    : isUpdate
                                                        ? 'bg-amber-500'
                                                        : 'bg-rose-500'
                                        ...
                                        <div className="bg-slate-50 dark:bg-slate-800/60 rounded-2xl p-4 border border-slate-200 dark:border-slate-700/50 space-y-2">
                                            <div className="flex items-center justify-between">
                                                <span
                                                    className={`text-xs font-bold px-2.5 py-0.5 rounded-full border ${isCreate
